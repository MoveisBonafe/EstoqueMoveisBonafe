        ...
        <Card>
          <CardContent className="p-8 text-center">
            <div className="bg-secondary-50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="material-icons text-3xl text-secondary-600">local_shipping</span>
            </div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Página de Fornecedores</h1>
            <p className="text-gray-600 mb-6">
              Esta página está em desenvolvimento. Em breve você poderá gerenciar todos os seus fornecedores aqui.
            </p>
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 text-left">
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-600">
                ...
                <li>Histórico de pedidos por fornecedor</li>
                <li>Avaliação de fornecedores</li>
                <li>Integração com sistema de pedidos</li>
